...
Public Class employees
    ...
    Private Function GetUserInformation(ByVal userId As Integer) As String
        ...
        Dim query As String = "SELECT fullname, username, password, email, address, number FROM tbl_employee WHERE eID = @userId"
    ...
    Private Sub btn_update_Click(sender As Object, e As EventArgs) Handles btn_update.Click
        ...
        If confirm = MsgBoxResult.Yes Then
            ...
            ds = New DataSet
            da = New MySqlDataAdapter("update tbl_employee set fullname=@fullname,username=@username,password=@password,email=@email,address=@address,number=@number where eID=@eID", sqlconn)
            da.SelectCommand.Parameters.AddWithValue("@eID", lbl_id.Text.ToUpper)
